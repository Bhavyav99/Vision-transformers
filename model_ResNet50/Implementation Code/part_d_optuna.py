...
if __name__ == "__main__":
    study = optuna.create_study(direction="minimize", pruner=optuna.pruners.MedianPruner(), storage="sqlite:///part_d_resnet.sqlite3", study_name ="part_d_resnet", load_if_exists=True)  # Minimize validation loss
