...
params = {
    'batch_size': 16,
    'lr': 0.007017489000600996,
    'optimizer_name': 'SGD',
    'dropout_rate': 0.47394437683003,
...
train_dataset = MBH_dataset(data_dir='/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/',
                                    label_file="/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/Labels/Part - D/model_train.txt",
                                    transform=train_transform)
train_dataset.load_data()

val_dataset = MBH_dataset(data_dir='/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/',
                          label_file="/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/Labels/Part - D/model_val.txt",
                          transform=val_transform)
val_dataset.load_data()

test_dataset = MBH_dataset(data_dir='/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/',
                          label_file="/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/Labels/Part - D/model_test.txt",
...
writer = SummaryWriter(log_dir="tensorboard_PART_D/")
...
trainer = pl.Trainer(
    ...
    max_epochs=100,
    callbacks=[pl.callbacks.EarlyStopping(monitor='val_loss', patience=12, mode='min', verbose=True)], logger=csv_logger
)

trainer.fit(custom_model)
torch.save(model.state_dict(), 'resnet_part_d.pth')
...
def test_model(model, dataloader):
    ...
    file_path = "resnet_part_d_test.csv"
