...
params = {
    'batch_size': 16,
    'lr': 0.00807639424080761,
    'optimizer_name': 'SGD',
    'dropout_rate': 0.06330339470660361,
...
train_dataset = MBH_dataset(data_dir='/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/',
                                    label_file="/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/Labels/Part - E/model_train.txt",
                                    transform=train_transform)
train_dataset.load_data()

val_dataset = MBH_dataset(data_dir='/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/',
                          label_file="/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/Labels/Part - E/model_val.txt",
                          transform=val_transform)
val_dataset.load_data()

test_dataset = MBH_dataset(data_dir='/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/',
                          label_file="/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/Labels/Part - E/model_test.txt",
...
writer = SummaryWriter(log_dir="tensorboard_PART_E/")
...
csv_logger = CSVLogger(save_dir="/home/hpc/iwfa/iwfa011h/Code/Code/Code/Code/Code/Code/ResNet50/logs/train", name="resnet_part_e")

trainer = pl.Trainer(
    accelerator="auto",  # Use GPU if available
    max_epochs=100,
    callbacks=[pl.callbacks.EarlyStopping(monitor='valc_f_nok', patience=9, mode='max')], logger=csv_logger
)

trainer.fit(custom_model)
torch.save(model.state_dict(), 'resnet_part_e.pth')
...
def test_model(model, dataloader):
    ...
    file_path = "resnet_part_e_test.csv"
