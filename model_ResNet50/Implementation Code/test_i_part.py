...
writer = SummaryWriter(log_dir="tensorboard_PART_I/")
...
trainer = pl.Trainer(
    ...
    max_epochs=100,
    callbacks=[pl.callbacks.EarlyStopping(monitor='valc_f_nok', patience=15, mode='max', verbose=True)], logger=csv_logger
)

trainer.fit(custom_model)
torch.save(model.state_dict(), 'resnet_part_i.pth')
...
def test_model(model, dataloader):
    ...
    file_path = "resnet_part_i_test.csv"
