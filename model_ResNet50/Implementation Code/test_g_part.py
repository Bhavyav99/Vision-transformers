...
params = {
    'batch_size': 64,
    'lr': 0.009764235570301715,
    'optimizer_name': 'SGD',
    'dropout_rate': 0.4126643280410985,
    'unfreeze_layers': 'all'
}
...
train_transform = transforms.Compose([
    ...
    transforms.GaussianBlur((kernel_size, kernel_size+2), sigma=(0.1, 5.)),
...
train_dataset = MBH_dataset(data_dir='/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/',
                                    label_file="/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/Labels/Part - G/model_train.txt",
                                    transform=train_transform)
train_dataset.load_data()

val_dataset = MBH_dataset(data_dir='/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/',
                          label_file="/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/Labels/Part - G/model_val.txt",
                          transform=val_transform)
val_dataset.load_data()

test_dataset = MBH_dataset(data_dir='/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/',
                          label_file="/home/woody/iwfa/iwfa011h/Fangjun_Wang_2021_MBH-dataset/MBH-dataset/Labels/Part - G/model_test.txt",
...
writer = SummaryWriter(log_dir="tensorboard_PART_G/")
...
torch.save(model.state_dict(), 'resnet_part_g.pth')
...
def test_model(model, dataloader):
    ...
    file_path = "resnet_part_g_test.csv"
