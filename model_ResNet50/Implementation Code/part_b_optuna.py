...
if __name__ == "__main__":
    study = optuna.create_study(direction="minimize", pruner=optuna.pruners.MedianPruner(), storage="sqlite:///optuna.sqlite3", study_name ="optuna_02_01_2024", load_if_exists=True)  # Minimize validation loss
