    ...
    def on_validation_epoch_end(self):
        ...
        try:
            if fn == 0:
                ...
                omission_rate_val_ok = fn / (tn + fn)
        except:
            omission_rate_val_ok = 1.0
...
if __name__ == "__main__":
    study = optuna.create_study(direction="minimize", pruner=optuna.pruners.MedianPruner(), storage="sqlite:///part_g_resnet.sqlite3", study_name ="part_g_resnet", load_if_exists=True)
